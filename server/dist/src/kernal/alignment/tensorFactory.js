...
const ALLOWED_AXIOM_TAGS = new Set([
    "AXIOM_1_BALANCE",
    "AXIOM_2_EXTREMES",
    "AXIOM_3_FORCE",
    "AXIOM_4_FLOW",
...
export class TensorFactory {
     ...
     */
    static generate(input, findings, type = "PT") {
        ...
        const coherence_score = safeFindings.length === 0 ? 0.9 : 0.5;
        // Canon-bound axiom tags only.
        const axiom_tags = safeFindings
            .map((f) => f?.axiom_tag)
            .filter((t) => typeof t === "string" && ALLOWED_AXIOM_TAGS.has(t));
        const hash = crypto
            .createHash("sha256")
            .update(input ?? "")
            .digest("hex")
...
//# sourceMappingURL=tensorFactory.js.map