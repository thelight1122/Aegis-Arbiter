...
export class LensMonitor {
    ...
    static evaluate(tensor) {
        ...
        if (status.emotional < 0.4)
            status.fractures.push("SYNTAX_ERROR: Emotional lens neglected (AXIOM_3_FORCE).");
        if (status.mental < 0.4)
            status.fractures.push("SYNTAX_ERROR: Mental lens fragmented (AXIOM_2_EXTREMES).");
...
//# sourceMappingURL=lensMonitor.js.map